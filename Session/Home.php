            ...
            >
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="collapsibleNavId">
                        ...
                        <form Action="Logout.php" class="d-flex my-2 my-lg-0">
                            <!-- <input
                        ...
                        <form Action="Registration.php" class="d-flex my-2 my-lg-0">
                            <!-- <input
                                class="form-control me-sm-2"
                                type="text"
                                placeholder="Search"
...
<body>
    ...
    <table border="1" cellpadding="10" cellspacing="10" width="50%" align="center" > 
        <tr>
            <td>ID</td>
            <td>Name</td>
            <td>Email</td>
