...
$sql=$conn->query("select * from employee"); // fixed ;
...
if($_SERVER["REQUEST_METHOD"]==="POST"){
    ...
    $stmt=$conn->prepare("insert into employee(name,age,salary,email) values(?,?,?,?)");
    $stmt->bind_param("sids", $name, $age, $salary, $email);
